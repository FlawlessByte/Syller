...
public class MyRecyclerViewAdapter extends RecyclerView
    ...
    public static class DataObjectHolder extends RecyclerView.ViewHolder
        ...
        public DataObjectHolder(View itemView) {
            ...
            subject_textView = (TextView) itemView.findViewById(R.id.subject_textView);
    ...
    public void onBindViewHolder(DataObjectHolder holder, int position) {
        holder.no_textView.setText(mDataset.get(position).getmNo());
        holder.code_textView.setText(mDataset.get(position).getmCode());
        holder.subject_textView.setText(mDataset.get(position).getmSubject());
    }
